...
"[project]/app/api/gifts/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const DATA_PATH = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), "data", "gifts.json");
const UPLOAD_DIR = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), "public", "uploads", "gifts");
...
async function PUT(request, { params }) {
    ...
    if (contentType.includes("multipart/form-data")) {
        ...
        const claimedByPhotoFile = form.get("claimedByPhoto");
...
async function DELETE(_request, { params }) {
    ...
    if (items[idx]?.claimed) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "claimed"
    }, {
        status: 409
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b3f96c1f._.js.map