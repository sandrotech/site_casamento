...
"[project]/app/api/gifts/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    ...
    const buf = await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].readFile(DATA_PATH, "utf-8");
    const data = JSON.parse(buf);
    const nextId = data.reduce((max, g)=>Math.max(max, Number(g.id) || 0), 0) + 1;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__45305360._.js.map