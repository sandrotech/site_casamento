...
"[project]/app/api/supporters/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const DATA_PATH = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), "data", "supporters.json");
const UPLOAD_DIR = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), "public", "uploads", "supporters");
async function ensureFile() {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].writeFile(DATA_PATH, "[]", "utf-8");
    }
}
...
async function POST(request) {
    ...
    async function saveFile(file, dir) {
        ...
        const full = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(dir, fname);
        await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].writeFile(full, buf);
        return fname;
    }
    if (ct.includes("multipart/form-data")) {
        const form = await request.formData();
        const name = String(form.get("supportName") || form.get("name") || "");
        const photoFile = form.get("supportPhoto") || form.get("photo");
        const receiptFile = form.get("receipt") || form.get("comprovante");
        let photoPath = "";
        let receiptPath = "";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__682bd079._.js.map